...
// async function get_img_url(key_word) {
// 	const option = {
// 		query: key_word
// 	};
// 	const config = {
// 		method: 'get',
// 		url: 'https://dapi.kakao.com/v2/search/image?page=1&size=50',
// 		params: option,
// 		headers: {
...
exports.get_menu = async function (req, res) {
	try {
		...
		result[0].img_url = await kakao_api.get_img_url(result[0].menu);
		result[1].img_url = await kakao_api.get_img_url(result[1].menu);
		...
		// let result = {};
		console.log(error);
		return res_handler.sendSuccess(error, 200, res, 'menu');
	}
};
