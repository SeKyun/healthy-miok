    ...
    const _filter = (html) => {
        ...
        $bodyList.each(function (i, elem) {
            ulList[i] = {
                ...
                city_name: $("#main_pack > div.sc.cs_weather_global._oversea_weather > div:nth-child(3) > div.weather_box > div.weather_area._mainArea > div.sort_box._areaSelectLayer > div > div > span > em").text(),
            }
        });
        if (! ulList[0].city_name) {
            ulList[0].city_name = "검색한 지역의 날씨"; 
        }
        if (ulList[0].cast_txt) {
            ...
            } else if (cast_status.includes('안개')) {
